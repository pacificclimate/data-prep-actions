...
do
    ...
    do
        ...
        #model=${base%_10}
        cat change_standard_long_names.pbs | sed 's#MODEL#'$model'#' > change_standard_long_names${inc}.pbs
        qsub change_standard_long_names${inc}.pbs
        rm change_standard_long_names${inc}.pbs
        ((inc++))
    done
done
